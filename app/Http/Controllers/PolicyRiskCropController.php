...
public function showrisks($company)
  ...
  public function showfarmersPolicyrisks1($va1,$va2)
    {
     $user=Policyfarmer::where('policyfarmers.id', $va1)->where('policyfarmers.status', 'active')->where('companies_id', $va2)->join('insurances','insurances.id','policyfarmers.policy_id')
    ...
    public function showfarmersPolicySanasa($va1,$va2)
    {
        ...
        $crop=Policyfarmer::where('policyfarmers.id', $va1)->where('companies_id', $va2)
                ...
                $res['cr']=$cr;       
      $user=Policyfarmer::where('policyfarmers.id', $va1)->where('companies_id', $va2)
 ...
 public function showwithoutrisk($va1,$va2)
    {
      $user=Policyfarmer::where('policyfarmers.id', $va1)->where('companies_id', $va2)->where('policyfarmers.status', 'active')->where('policyfarmers.risk_type',NULL)
        ->join('insurances','insurances.id','policyfarmers.policy_id')
